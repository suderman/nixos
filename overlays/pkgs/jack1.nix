# remove once jack1 0.126.0 is availble
# https://search.nixos.org/packages?channel=unstable&show=jack1&from=0&size=50&sort=relevance&type=packages&query=jack
{
  lib,
  stdenv,
  fetchurl,
