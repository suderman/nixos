# https://github.com/NixOS/nixpkgs/pull/294641
# https://github.com/NixOS/nixpkgs/blob/d0a3863808e35562c5f642fcec6cb02ae0aec5b8/nixos/modules/services/networking/sunshine.nix
{ config, lib, pkgs, ... }:
let
