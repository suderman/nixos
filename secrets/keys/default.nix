# 49dedce5fe433ec1b8fbb29b89436602
...
rec {
  ...
  systems.all = [ systems.cog systems.lux systems.nimbus systems.sol systems.test-1678320147 systems.test-1678320173 systems.test ];
